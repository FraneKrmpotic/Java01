...
public class Movie {
    ...
    public Movie(int id, String hrTitle, LocalDateTime publishedDate, String description, String enTitle, String director, String actors, int duration, String genres, String picturePath) {
        this(hrTitle, publishedDate, description, enTitle, director, actors, duration, genres, picturePath);
        this.id = id;
    }

    public Movie(String hrTitle, LocalDateTime publishedDate, String description, String enTitle, String director, String actors, int duration, String genres, String picturePath) {
